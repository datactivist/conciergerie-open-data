...
def add_new_search_query(search_data):
    ...
    try:
        ...
        if sqliteConnection:
            sqliteConnection.close()
            print("Added new search query successfully\n")
...
def add_feedback_augmentation(search_data, feedback_augmentation_data):
    ...
    try:
        ...
        sqlite_check_feedback_exist_query = (
            'SELECT search_feedback_id FROM feedback_user_search where conversation_id = "'
            + conversation_id
            + '" and keywords_user = "'
            + keywords_user
            + '";'
        ...
        if feedback_id is None:
            ...
            print("Feedback already present")
...
def add_feedback_results(search_data, feedback_results_data):
    ...
    try:
        ...
        sqlite_check_feedback_exist_query = (
            'SELECT results_feedback_id FROM feedback_user_search where conversation_id = "'
            + conversation_id
            + '" and keywords_user = "'
            + keywords_user
            + '";'
